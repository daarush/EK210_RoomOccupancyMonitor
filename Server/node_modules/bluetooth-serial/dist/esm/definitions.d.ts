...
export interface BluetoothSerialPlugin {
    ...
    addListener(event: 'connectionChange', listenerFunc: (event: {
        state: ConnectionState;
    }) => any): Promise<PluginListenerHandle> & PluginListenerHandle;
...
export declare type permissions = 'coarseLocation' | 'fineLocation' | 'scan' | 'connect';
export declare type PermissionStatus = {
